...
class SurfCnn(SurfNews):
    def __init__(self, browser, category=None, allow_share_article=None, keyword=None):
        ...
        self.domain = "cnn.com"                # Start Url Domain
    ...
    def start_session(self):
        ...
        logging.info(str(" " + str(self.number_of_pages_visited + 1) + ". Navigating " + self.url))         # Log
